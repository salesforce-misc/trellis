...
use super::ast::{
    ...
    RelationshipDef, Statement, StatementKind, TransformDef, TransformRef,
};
...
/// Which form the statement `input` is, decided by parsing all of it with
/// [`parse_statement`] — so the answer is always the form
